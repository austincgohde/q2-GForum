  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {first_name: 'Austin', last_name: 'Gohde', cohort_id: 1, email: "austin.gohde@gforumcom", password: "$2a$10$EWgQya/x9itL1Mq1306gcenhZKmEBWHc5YhVnNqu9FS3tLLAlVgDS", auth_level: 2}
      ]);
    });
};
